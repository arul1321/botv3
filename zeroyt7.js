...
creator = 'ArulGanz' // GAK USAH DI UBAH ANJING HARGA CREATOR
recode = 'ArulGanz' // UBAH NAMA LU
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Bahagia Karena Itu Sangat Sederhana',
			error: {
...
const daftar2 = 'Jangan Lupa Follow Instagram Gw\nhttps://bit.ly/3vwk1rf'
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Follow Instagram _daaa_1`, 
                            orderTitle: `FOLOW INSTAGRAM _daaa_1`,
...
├ ㋡  ٬࿊⃟🐤${prefix}asupansantuy
├ ㋡  ٬࿊⃟🐤${prefix}asupanukhti
...
JANGAN LUPA FOLLOW INSTAGRAM GW :V
https://bit.ly/3vwk1rf
`
...
but = [
        ...
        sendButImage(from, teks, "©ArulGanz", gam, but)
break
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1'})
break
case 'tiktok':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1'})
break
case 'asupancecan':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1'})
break
case 'asupanhijaber':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1'})
break
case 'cecanmalaysia':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
┃┃✯ Runtime : ${runtime(process.uptime())}
┃┃✯ Follow IG : https://bit.ly/3vwk1rf
┗━━━━━━━`
gam = fs.readFileSync('./zeroyt7/zero.jpg')
but = [
...
└──────[ GITHUB ]──────❒
  │◦➛Script Ory :
  │◦➛Gw Nyari SC Susah Tolol
  │◦➛Script Recode : 
  │◦➛Gak Ada Pokoknya Gak Ada
  └──────────────────❒`
but = [
{ buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
{ buttonId: `${prefix}sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },
...
sendButton(from, "GOPAY : 085157740529 (ArulGanz)", faketeks, but, mek)
break
case 'dana':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "DANA : 081229859085 (ArulGanz)", faketeks, but, mek)
break
case 'ovo':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "OVO : 081229859085 (ArulGanz)", faketeks, but, mek)
break
case "runtime":
case "test":
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
but = [
        ...
        sendButImage(from, kimak, "©ArulGanz", gam, but)
break
case 'donasi':
...
Semoga Rejekinya Tambah Lancar Amin
    ...
    ╭───────────────❏
❍┤ヅ Gopay : 081229859085
❍┤ヅ Dana : 081229859085
❍┤ヅ Ovo : 081229859085
❍┤ヅ Pulsa : 081229859085
    ╰───────────────❏`
gam = fs.readFileSync('./zeroyt7/zerothumb.jpg')
but = [
          { buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
